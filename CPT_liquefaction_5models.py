...
st.write("# Assessment of Liquefaction Potential of Soil based on Cone Penetration Test")
st.write("## Machine Learning Classification Models Trained on Historical Data")
st.markdown(
...
def plot_historical_data(test_df):
    ...
    path = 'juang_2003_data_with_CSR.csv'
...
if submit_1:
    ...
    preds_df = pd.DataFrame({'MODELS': model_index, 'Liquefaction Potential': text_labels,
                              'Probability of Liquefaction': scores}) # , index=model_index
